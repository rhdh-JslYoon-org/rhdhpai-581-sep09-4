...
!!! info
    ...
    **Source Code Repository:** [https://github.com/rhdh-JslYoon-org/rhdhpai-581-sep09-4](https://github.com/rhdh-JslYoon-org/rhdhpai-581-sep09-4)

    **GitOps Repository:** [https://github.com/rhdh-JslYoon-org/rhdhpai-581-sep09-4-gitops](https://github.com/rhdh-JslYoon-org/rhdhpai-581-sep09-4-gitops)

# **Usage**

To access the rhdhpai-581-sep09-4 application that was deployed using the Software Template, complete the following instructions:
...
If you are interested in seeing the deployed Kubernetes resources, all resources were deployed into your chosen namespace of rhdhpai-581-sep09-4. You can access this namespace through the web console or via your CLI.
